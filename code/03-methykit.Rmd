...
```{r}
Sys.getenv()[ grep("LIB|PATH", names(Sys.getenv())) ]if (!requireNamespace("BiocManager", quietly = TRUE))
...
myobj_all = processBismarkAln(location = file.list_all,
  sample.id = list("12M","13M","16F","19F","22F","23M","29F","31M", "35F","36F","39F","3F","41F","44F","48F","50F","52F","53F","54F","59M","64M","6M","76F", "77F","7M","9M"),
  assembly = "cv",
  read.context="CpG",
  mincov=2,
