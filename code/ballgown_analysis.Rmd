...
```{r DETs-female-OA}
# Load phenotype info into Ballgown
pData(bg) <- sample_metadata_subset_female_only

stat_results = stattest(bg, feature='transcript', meas='FPKM', covariate="TreatmentN", getFC = TRUE)
head(stat_results)
...
```{r DETs-female-OA}
# Load phenotype info into Ballgown
pData(bg) <- sample_metadata_subset_male_only
