...
rm(transcripts_treatment_fpkm_CoV_df, transcripts_control.vs.exposed_fpkm_CoV_df, transcripts_female.vs.male_fpkm_CoV_df)
  ...
  for (index in 1:length(treatment_fpkm_list))  {
    if (comparison == "all") {
      ...
      if (exists("transcripts_treatment_fpkm_CoV_df")) {
        ...
        transcripts_treatment_fpkm_CoV_df$column <- rowcvs(treatment_fpkm_list[[index]], unbiased = TRUE)
      } else
          # Creates initial data frame with coefficients of variation for FPKM in Treatment 1
          transcripts_treatment_fpkm_CoV_df <- as.data.frame(rowcvs(treatment_fpkm_list[[index]], unbiased = TRUE))
    ...
    if (comparison == "f_v_m" & (index == "2" || index == "4")) {
      ...
      if (exists("transcripts_female.vs.male_fpkm_CoV_df")) {
        ...
        # Add new column with coefficients of variation for each subsequent TreatmentN
        transcripts_female.vs.male_fpkm_CoV_df$column <- rowcvs(females_matrix, unbiased = TRUE)
      } else
          # Creates initial data frame with coefficients of variation for FPKM in Treatment 1
          transcripts_female.vs.male_fpkm_CoV_df <- as.data.frame(rowcvs(females_matrix, unbiased = TRUE))
        ...
        if (exists("transcripts_female.vs.male_fpkm_CoV_df")) {
          ...
          # Add new column with coefficients of variation for each subsequent TreatmentN
          transcripts_female.vs.male_fpkm_CoV_df$column <- rowcvs(males_matrix, unbiased = TRUE)
        } else
            # Creates initial data frame with coefficients of variation for FPKM in Treatment 1
            transcripts_female.vs.male_fpkm_CoV_df <- as.data.frame(rowcvs(males_matrix, unbiased = TRUE))
        ...
        if (exists("transcripts_control.vs.exposed_fpkm_CoV_df")) {
          ...
          # Add new column with coefficients of variation for each subsequent TreatmentN
          transcripts_control.vs.exposed_fpkm_CoV_df$column <- rowcvs(controls_matrix, unbiased = TRUE)
        } else
            # Creates initial data frame with coefficients of variation for FPKM in Treatment 1
            transcripts_control.vs.exposed_fpkm_CoV_df <- as.data.frame(rowcvs(controls_matrix, unbiased = TRUE))
        ...
        if (exists("transcripts_control.vs.exposed_fpkm_CoV_df")) {
          ...
          # Add new column with coefficients of variation for each subsequent TreatmentN
          transcripts_control.vs.exposed_fpkm_CoV_df$column <- rowcvs(exposed_matrix, unbiased = TRUE)
        } else
            # Creates initial data frame with coefficients of variation for FPKM in Treatment 1
            transcripts_control.vs.exposed_fpkm_CoV_df <- as.data.frame(rowcvs(exposed_matrix, unbiased = TRUE))
    }
  }
}
