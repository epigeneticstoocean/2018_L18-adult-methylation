...
fpkm_dataframes <- c("control.vs.exposed_fpkm_CoV_df", "female.vs.male_fpkm_CoV_df", "treatment_fpkm_CoV_df")
...
for (dataframe in fpkm_dataframes) {
  write.csv(dataframe,
            file = paste0("../analyses/", dataframe, ".csv"),
            row.names = FALSE,
            quote = FALSE)
}
```
