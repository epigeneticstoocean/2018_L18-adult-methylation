...
write.table(fpkm, file = "./analyses/fpkm_all_samples.tab", sep = "\t")
...
fpkm_libraries_sorted <- fpkm_df_pivot[with(fpkm_df_pivot, order("sex", "library"))]
fpkm_libraries_sorted_unique <- (unique(fpkm_df_pivot_sorted$library))
fpkm_libraries_sorted_unique

fpkm_df_pivot_sorted <- fpkm_df_pivot %>% arrange(sex)
fpkm_df_pivot_sorted
