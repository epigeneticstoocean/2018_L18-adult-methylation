...
transcript_counts_per_gene_per_sample <- transcript_counts %>%
  rowwise() %>% 
  mutate(
    sum_transcript_counts = sum(c_across(where(is.numeric))),
    median_transcript_counts = median(c_across(where(is.numeric))),
    mean_transcript_counts = mean(c_across(where(is.numeric))),
    max_transcript_counts = max(c_across(where(is.numeric))),
    min_transcript_counts = min(c_across(where(is.numeric))),
    std_dev_transcript_counts = sd(c_across(where(is.numeric)))
  )
...
transcript_counts_per_gene_per_sample_males <- transcript_counts %>%
  ...
  mutate(
    male_sum_transcript_counts = sum(c_across(where(is.numeric))),
    male_median_transcript_counts = median(c_across(where(is.numeric))),
    male_mean_transcript_counts = mean(c_across(where(is.numeric))),
    male_max_transcript_counts = max(c_across(where(is.numeric))),
    male_min_transcript_counts = min(c_across(where(is.numeric))),
    male_std_dev_transcript_counts = sd(c_across(where(is.numeric)))
  )
...
transcript_counts_per_gene_per_sample_females <- transcript_counts %>%
  ...
  mutate(
    female_sum_transcript_counts = sum(c_across(where(is.numeric))),
    female_median_transcript_counts = median(c_across(where(is.numeric))),
    female_mean_transcript_counts = mean(c_across(where(is.numeric))),
    female_max_transcript_counts = max(c_across(where(is.numeric))),
    female_min_transcript_counts = min(c_across(where(is.numeric))),
    female_std_dev_transcript_counts = sd(c_across(where(is.numeric)))
  )
...
transcript_counts_per_gene_per_sample_controls <- transcript_counts %>%
  ...
  mutate(
    controls_sum_transcript_counts = sum(c_across(where(is.numeric))),
    controls_median_transcript_counts = median(c_across(where(is.numeric))),
    controls_mean_transcript_counts = mean(c_across(where(is.numeric))),
    controls_max_transcript_counts = max(c_across(where(is.numeric))),
    controls_min_transcript_counts = min(c_across(where(is.numeric))),
    controls_std_dev_transcript_counts = sd(c_across(where(is.numeric)))
  )
...
transcript_counts_per_gene_per_sample_exposed <- transcript_counts %>%
  ...
  mutate(
    exposed_sum_transcript_counts = sum(c_across(where(is.numeric))),
    exposed_median_transcript_counts = median(c_across(where(is.numeric))),
    exposed_mean_transcript_counts = mean(c_across(where(is.numeric))),
    exposed_max_transcript_counts = max(c_across(where(is.numeric))),
    exposed_min_transcript_counts = min(c_across(where(is.numeric))),
    exposed_std_dev_transcript_counts = sd(c_across(where(is.numeric)))
  )
...
transcript_counts_per_gene_per_sample_controls_females <- transcript_counts %>%
  ...
  mutate(
    control_females_sum_transcript_counts = sum(c_across(where(is.numeric))),
    control_females_median_transcript_counts = median(c_across(where(is.numeric))),
    control_females_mean_transcript_counts = mean(c_across(where(is.numeric))),
    control_females_max_transcript_counts = max(c_across(where(is.numeric))),
    control_females_min_transcript_counts = min(c_across(where(is.numeric))),
    control_females_std_dev_transcript_counts = sd(c_across(where(is.numeric)))
  )
...
transcript_counts_per_gene_per_sample_exposed_females <- transcript_counts %>%
  ...
  mutate(
    exposed_females_sum_transcript_counts = sum(c_across(where(is.numeric))),
    exposed_females_median_transcript_counts = median(c_across(where(is.numeric))),
    exposed_females_mean_transcript_counts = mean(c_across(where(is.numeric))),
    exposed_females_max_transcript_counts = max(c_across(where(is.numeric))),
    exposed_females_min_transcript_counts = min(c_across(where(is.numeric))),
    exposed_females_std_dev_transcript_counts = sd(c_across(where(is.numeric)))
  )
...
transcript_counts_per_gene_per_sample_controls_males <- transcript_counts %>%
  ...
  mutate(
    control_males_sum_transcript_counts = sum(c_across(where(is.numeric))),
    control_males_median_transcript_counts = median(c_across(where(is.numeric))),
    control_males_mean_transcript_counts = mean(c_across(where(is.numeric))),
    control_males_max_transcript_counts = max(c_across(where(is.numeric))),
    control_males_min_transcript_counts = min(c_across(where(is.numeric))),
    control_males_std_dev_transcript_counts = sd(c_across(where(is.numeric)))
  )
...
transcript_counts_per_gene_per_sample_exposed_males <- transcript_counts %>%
  ...
  mutate(
    exposed_males_sum_transcript_counts = sum(c_across(where(is.numeric))),
    exposed_males_median_transcript_counts = median(c_across(where(is.numeric))),
    exposed_males_mean_transcript_counts = mean(c_across(where(is.numeric))),
    exposed_males_max_transcript_counts = max(c_across(where(is.numeric))),
    exposed_males_min_transcript_counts = min(c_across(where(is.numeric))),
    exposed_males_std_dev_transcript_counts = sd(c_across(where(is.numeric)))
  )
